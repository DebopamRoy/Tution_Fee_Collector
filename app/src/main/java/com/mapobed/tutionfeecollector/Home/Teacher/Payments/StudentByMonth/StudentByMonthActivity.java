...
import com.mapobed.tutionfeecollector.Home.Teacher.Studentss.MatesTeacherAdapter;
import com.mapobed.tutionfeecollector.Home.Teacher.Studentss.MatesTeacherModelClass;
import com.mapobed.tutionfeecollector.R;

import java.util.ArrayList;
import java.util.List;

public class StudentByMonthActivity extends AppCompatActivity implements MatesTeacherAdapter.StudentTeacherInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_by_month);
        ...
        recyclerView = findViewById(R.id.rec_tea_sem);
    ...
    public void onClick(MatesTeacherModelClass modelClass) {
        startActivity(new Intent(StudentByMonthActivity.this, ShowPaidStudentActivity.class)
                .putExtra("selected", modelClass.getNamee()).putExtra("month",getIntent().getStringExtra("month_name")));
    }
}
